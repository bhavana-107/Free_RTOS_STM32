//One task sends a variable value to Queue whenever a button is pressed and variable value is get updadated, another task receives them and prints via UART
